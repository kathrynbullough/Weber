...
#Plot mean t1
#plot_mean_t1 <- ggplot(data=sim_data
#        ,mapping=aes(x=generation
#                ,y=meant1)) +
#    geom_line(mapping=aes(x=generation,y=meant1))

#Plot mean p1
#plot_mean_p1 <- ggplot(data=sim_data
#        ,mapping=aes(x=generation
#                ,y=meanp1)) +
...
plot_pt<-ggplot(data=sim_data, aes(x=meanp1, y=meant1)) + 
    ...
    geom_point(size=1, aes(x=meanp2, y=meant2), colour="blue") +
    geom_point(size=1, aes(x=meanp3, y=meant3),colour="green") +    
    geom_point(size=1, aes(x=meanp4, y=meant4),colour="pink") +
    geom_point(size=1, aes(x=meanp5, y=meant5),colour="black") +
    geom_path(mapping=aes(x=meanp1,y=meant1), colour="red") +
    geom_path(mapping=aes(x=meanp2,y=meant2), colour="blue") +
    geom_path(mapping=aes(x=meanp3,y=meant3), colour="green") +
    geom_path(mapping=aes(x=meanp4,y=meant4), colour="pink") +
    geom_path(mapping=aes(x=meanp5,y=meant5), colour="black") +
    theme_classic()
    
plot_t_gen <- ggplot(data=sim_data, mapping=aes(x=generation, y=meant1)) +
    geom_point(size=1, colour="red") +
    geom_point(size=1, aes(x=generation, y=meant2), colour="blue") +
    geom_point(size=1, aes(x=generation, y=meant3),colour="green") +    
    geom_point(size=1, aes(x=generation, y=meant4),colour="pink") +
    geom_point(size=1, aes(x=generation, y=meant5),colour="black") +
    geom_line(mapping=aes(x=generation,y=meant1, colour="red")) +
    geom_line(mapping=aes(x=generation,y=meant2), colour="blue") +
    geom_line(mapping=aes(x=generation,y=meant3), colour="green") +
    geom_line(mapping=aes(x=generation,y=meant4), colour="pink") +
    geom_line(mapping=aes(x=generation,y=meant5), colour="black") +
    theme_classic()
    
plot_p_gen <- ggplot(data=sim_data, mapping=aes(x=generation, y=meanp1)) +
    geom_point(size=1, colour="red") +
    geom_point(size=1, aes(x=generation, y=meanp2), colour="blue") +
    geom_point(size=1, aes(x=generation, y=meanp3),colour="green") +    
    geom_point(size=1, aes(x=generation, y=meanp4),colour="pink") +
    geom_point(size=1, aes(x=generation, y=meanp5),colour="black") +
    geom_line(mapping=aes(x=generation,y=meanp1, colour="red")) +
    geom_line(mapping=aes(x=generation,y=meanp2), colour="blue") +
    geom_line(mapping=aes(x=generation,y=meanp3), colour="green") +
    geom_line(mapping=aes(x=generation,y=meanp4), colour="pink") +
    geom_line(mapping=aes(x=generation,y=meanp5), colour="black") +
    theme_classic()
    
plot_vart_gen <- ggplot(data=sim_data, mapping=aes(x=generation, y=vart1)) +
    geom_point(size=1, colour="red") +
    geom_point(size=1, aes(x=generation, y=vart2), colour="blue") +
    geom_point(size=1, aes(x=generation, y=vart3),colour="green") +    
    geom_point(size=1, aes(x=generation, y=vart4),colour="pink") +
    geom_point(size=1, aes(x=generation, y=vart5),colour="black") +
    geom_line(mapping=aes(x=generation,y=vart1, colour="red")) +
    geom_line(mapping=aes(x=generation,y=vart2), colour="blue") +
    geom_line(mapping=aes(x=generation,y=vart3), colour="green") +
    geom_line(mapping=aes(x=generation,y=vart4), colour="pink") +
    geom_line(mapping=aes(x=generation,y=vart5), colour="black") +
    theme_classic()
    
plot_varp_gen <- ggplot(data=sim_data, mapping=aes(x=generation, y=varp1)) +
    geom_point(size=1, colour="red") +
    geom_point(size=1, aes(x=generation, y=varp2), colour="blue") +
    geom_point(size=1, aes(x=generation, y=varp3),colour="green") +    
    geom_point(size=1, aes(x=generation, y=varp4),colour="pink") +
    geom_point(size=1, aes(x=generation, y=varp5),colour="black") +
    geom_line(mapping=aes(x=generation,y=varp1, colour="red")) +
    geom_line(mapping=aes(x=generation,y=varp2), colour="blue") +
    geom_line(mapping=aes(x=generation,y=varp3), colour="green") +
    geom_line(mapping=aes(x=generation,y=varp4), colour="pink") +
    geom_line(mapping=aes(x=generation,y=varp5), colour="black") +
    theme_classic()
