...
parameter_object$k1 <- 0.5   #How the cost of ornamentation depeneds on general viability (k=0 implies ornament cost is independent of viability)
parameter_object$k2 <- 0.5
