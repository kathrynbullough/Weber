...
parameter_object$b <- 0.0025     #Cost of preference
...
parameter_object$sdmu_p1 <- 0.2
parameter_object$sdmu_p2 <- 0.0
parameter_object$sdmu_t1 <- 0.2
parameter_object$sdmu_t2 <- 0.0
parameter_object$sdmu_v <- 0.2
